            ...
            <View style={{ flex: 3, justifyContent: "center", alignContent: "center" }}>
                <View style={{ flex: 1, flexDirection: "column", alignContent: "center", alignItems: "center", padding: 10 }}>
                    ...
                    <Text style={styles.titleText}>
                        Magnitis adalah Aplikasi modul {"\n"}
                    pembelajaran fisika yang berisi materi {"\n"}
                     medan magnet yang dapat digunakan {"\n"}
                      sebagai multimedia pembelajaran bagi peserta didik
                    </Text>
                </View>
            </View>
            <View style={{ flex: 2 }}>
